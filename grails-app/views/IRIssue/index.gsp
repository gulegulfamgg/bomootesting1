        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
            ...
            <table id="irIssueTable" class="striped bordered highlight" >
                ...
                <tbody id="RequestTBody">
                    <g:each in="${flash.irissue}" var="irissue">
                        <tr data-irissue-id="${flash.irissue.id}" ><td>${flash.irissue.id}</td><td>${flash.irissue.type}</td><td>${flash.irissue.msg}</td><td>${flash.irissue.submittedBy.name}</td><td>${flash.irissue.submittedOn}</td></tr>
                    </g:each>
                </tbody>
            </table>
        </div>
