...
<html>
    ...
    <body>
        <div class="notify-success" > Notice was created successfully </div>
       <div class="div960">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <h3> Create Notice </h3><hr>
                <form id="form">
                    <input class="form-control" type="text" name="title" id="title" placeholder="Heading" />
                    <textarea class="form-control" id="content" name="content" style="width: 100%; height: 300px; resize:vertical;" placeholder="Notice"></textarea>
        ...
        <script type="text/javascript">
            ...
            $('#form').on('submit', function(e) {
                ...
                $.ajax({
                    type:'POST',
                    url: "${g.createLink(controller:'Notice', action:'saveNotice')}",
                    data: formData,
                    async: true,
                    cache:false,
                    contentType: false,
